            ...
            <el-tab-pane label="参数设置">
              <el-form :model="searchForm" ref="searchForm">
                <el-row>
                  ...
                  <el-col :span="6">
                    <div class="demo-input-suffix">
                      <el-input v-model="searchForm.k" placeholder="请输入内容">
            ...
            <el-tab-pane label="参数设置">
              ...
              <template>
                ...
                >
                  ...
                  <el-table-column prop="k" label="名称" width="180"></el-table-column>
                  <el-table-column prop="v" label="值" width="180"></el-table-column>
              ...
              >
                <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
                  ...
                  <el-form-item label="名称" prop="k">
                    <el-input v-model="addForm.k" auto-complete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="值" prop="v">
                    <el-input v-model="addForm.v" auto-complete="off"></el-input>
                  </el-form-item>
              ...
              >
                <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
                  ...
                  <el-form-item label="名称" prop="k">
                    <el-input v-model="editForm.k" auto-complete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="值" prop="v">
                    <el-input v-model="editForm.v" auto-complete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="排序" prop="sortCode">
...
export default {
  ...
  methods: {
    ...
    handleSearch: function() {
      ...
      self.$axios
        .post(
          "/SpringParameter/ListByPage?page=" +
    ...
    handleSave: function(formName) {
      ...
      self.$refs[formName]
        .validate(valid => {
          if (valid) {
            self.$axios
              .post("/SpringParameter/Create", this.addForm)
              .then(res => {
    ...
    handleUpdate: function(formName) {
      let self = this;
      self.$axios
        .post("/SpringParameter/Edit", this.editForm)
        .then(res => {
          self.$message.success(res.data.msg);
          self.handleSearch();
    ...
    handleSingleDelete(index, row) {
      ...
      self
        ...
        .then(() => {
          ...
          axios
            .post("/SpringParameter/SetDeleted", qs.stringify(para))
            .then(res => {
              self.$message.success(res.data.msg);
              self.handleSearch();
            })
