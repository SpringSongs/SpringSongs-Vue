  ...
  export default {
    ...
    methods: {
      ...
      loadTrea: function(resolve, parentId) {
        ...
        self.$axios.post("/SpringResource/GetMenusByParent", qs.stringify({
          "parentId": parentId,
      ...
      handleListSystem: function() {
        let self = this;
        self.$axios.post('/SpringSystem/ListAll',
      ...
      handleSearch: function() {
        ...
        self.$axios.post('/SpringResource/ListByPage?page=' + self.searchForm.page + "&size=" + self.searchForm.size,
          self.searchForm).then(function(response) {
      ...
      handleSave: function(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$axios.post('/SpringResource/Create', this.addForm).then((res) => {
      ...
      handleUpdate: function(formName) {
        let self = this;
        this.$axios.post('/SpringResource/Edit', this.editForm).then((res) => {
          self.$message.success(res.data.msg);
          self.handleSearch();
      ...
      handleDel: function() {
        ...
        this.$confirm('确认删除该记录吗?', '提示', {
          ...
          self.$axios.post('/SpringResource/SetDeleted', qs.stringify({
            'ids': ids
          }, {
            indices: false
      ...
      handleSingleDelete(index, row) {
        ...
        self.$confirm('确认删除该记录吗?', '提示', {
          ...
          axios.post('/SpringResource/setDeleted', qs.stringify(para))
            .then(function(response) {
              self.$message.success(response.data.msg);
              self.handleSearch();
            })
      ...
      handleExport: function() {
        axios.post('/SpringResource/export')
          .then(function(response) {
            self.$message.success(res.data.msg);
            self.handleSearch();
          })
