 ...
 -->
							...
							<template>
								<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" highlight-current-row style="width: 100%;"
								 @selection-change="handleSelectionChange">
									...
									<el-table-column prop='groupCode' label='组别编码' width='180'></el-table-column>
									<el-table-column prop='groupTitle' label='组别名称' width='180'></el-table-column>
									<el-table-column prop='taskTitle' label='任务名称' width='180'></el-table-column>
									<el-table-column prop='taskClassTitle' label='任务类' width='180'></el-table-column>
									<el-table-column prop='cronExpression' label='时间表达式' width='180'></el-table-column>
									...
									<el-table-column fixed='right' label='操作' width='250'>
										<template slot-scope='scope'>
											<el-button icon="el-icon-edit" @click='handlePauseEdit(scope.$index, scope.row)' type='text' size='small'>暂停</el-button>
											<el-button icon="el-icon-edit" @click='handleResumeEdit(scope.$index, scope.row)' type='text' size='small'>恢复</el-button>
							...
							<el-dialog title='新增' :visible.sync='dialogAddVisible' width='50%' :before-close='handleClose'>
								<el-form :model='addForm' label-width='80px' :rules='addFormRules' ref='addForm'>
									...
									<el-form-item label='任务名称' prop="taskTitle">
										<el-input v-model='addForm.taskTitle' auto-complete='off'></el-input>
									</el-form-item>
									<el-form-item label='任务类' prop="taskClassTitle">
										<el-input v-model='addForm.taskClassTitle' auto-complete='off'></el-input>
									</el-form-item>
							...
							<el-dialog title='修改' :visible.sync='dialogEditVisible' width='50%' :before-close='handleClose'>
								<el-form :model='editForm' label-width='80px' :rules='editFormRules' ref='editForm'>
									...
									<el-form-item label='任务名称' prop="taskTitle">
										<el-input v-model='editForm.taskTitle' auto-complete='off'></el-input>
									</el-form-item>
									<el-form-item label='任务类' prop="taskClassTitle">
										<el-input v-model='editForm.taskClassTitle' auto-complete='off'></el-input>
									</el-form-item>
									<el-form-item label='时间表达式' prop="cronExpression">
