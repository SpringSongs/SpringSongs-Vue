    ...
    .controller('StencilController', ['$rootScope', '$scope', '$http', '$modal', '$timeout', function ($rootScope, $scope, $http, $modal, $timeout) {
        ...
        $scope.editorFactory.promise.then(function () {
            ...
            /*
             StencilSet items
             */
            //$http({method: 'GET', url: KISBPM.URL.getStencilSet(), withCredentials: true})
             var stencilSetUrl=KISBPM.URL.getStencilSet();
             console.log(stencilSetUrl);

             $http({method: 'GET', url: stencilSetUrl , withCredentials: true}).success(function (data, status, headers, config) {
