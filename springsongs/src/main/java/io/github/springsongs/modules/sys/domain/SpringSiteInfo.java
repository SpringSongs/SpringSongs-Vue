...
@ApiModel(description="站点信息实体")
@Entity
@DynamicInsert(true)
@DynamicUpdate(true)
@Table(name = "spring_site_info", schema = "base_system")
public class SpringSiteInfo  extends SpringBase implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2878560585137375720L;
	@Id
