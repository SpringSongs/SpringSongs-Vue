            ...
            <el-tab-pane label="参数设置">
              ...
              <template>
                ...
                >
                  ...
                  <el-table-column prop="k" label="名称" width="180" />
                  <el-table-column prop="v" label="值" width="180" />
              ...
              >
                <el-form ref="addForm" :model="addForm" label-width="80px" :rules="addFormRules">
                  ...
                  <el-form-item label="名称" prop="k">
                    <el-input v-model="addForm.k" auto-complete="off" />
                  </el-form-item>
                  <el-form-item label="值" prop="v">
                    <el-input v-model="addForm.v" auto-complete="off" />
                  </el-form-item>
              ...
              >
                <el-form ref="editForm" :model="editForm" label-width="80px" :rules="editFormRules">
                  ...
                  <el-form-item label="名称" prop="k">
                    <el-input v-model="editForm.k" auto-complete="off" />
                  </el-form-item>
                  <el-form-item label="值" prop="v">
                    <el-input v-model="editForm.v" auto-complete="off" />
                  </el-form-item>
                  <el-form-item label="排序" prop="sortCode">
